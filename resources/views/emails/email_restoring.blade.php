				...
				<div style="border: 4px solid #f5f6f6;">
					...
					<div style="padding: 0 5px;">
						<div style="max-width: 500px; margin: 0 auto;">
							<h2 style="font-size: 20px; color: #595959">Приветствуем, ___________ !</h1>
							<p style="font-size:14px; line-height: 1.5; margin: 5px 0">Вы запросили восстановление пароля для вашего аккаунта. Для этого перейдите по ссылке ниже.</p>
								<div style="text-align: center; margin: 30px 0;">
									<a href="#" style="padding: 12px 30px; border-radius: 3px; text-decoration: none; text-transform: uppercase; font-weight: normal;font-size: 12px;background-color: #02cbf7; color: #fff;">Восстановить доступ</a>
								</div>
							</p>
							<p style="font-size:14px; line-height: 1.5; margin: 5px 0">Если вы не совершали запрос на восстановление – проигнорируйте это письмо.</p>
