        ...
        <tbody>
            ...
            <tr>
                <td colspan="2" style="text-align: left; padding: 20px 30px; font-size:16px; line-height: 1.4;">
                    ...
                    <p style="margin: 0 0 10px;">Вы успешно прошли регистрацию на Dreamstarter.</p>
                    <p style="margin: 0 0 10px;">Ваш E-mail для входа: {{$email}}</p>
                    <p style="margin: 0 0 10px;">Автоматический пароль: {{$password}}</p>
                    
                    <div style=" margin: 30px 0 30px; text-align: center;">

                        <a href="{{ route('home') }}" style=" margin:0 0 4px; display: inline-block; padding: 11px 15px; text-decoration: none; text-transform: uppercase; font-weight: bold; font-size: 15px; background-color: #07d9e8; color: #fff;">Перейти {{ route('home') }}</a>
