<?php
return [
    'textrules1'=>'<h2>Вітаємо на <span class="caption">Dreamstarter!</span></h2>
    ...
    'textrules2-6'=>'<p>Якщо в процесі створення проекту у вас виникнуть питання, пишіть на адресу <a href="mailto:support@dreamstarter.com.ua">support@dreamstarter.com.ua.</a></p>',
    'textrules2-7'=>'<label>Я приймаю умови <a href="/rules_service" target="_blank">Правил</a> та <a href="/compliance" target="_blank">Угоди користувача</a>.</label>',
    'sidebar'=>'<h4 class="rules_page_title">Забороняються проекти, які:</h4>
